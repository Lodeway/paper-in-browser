...
import xyz.wagyourtail.jvmdg.shade.asm.Handle;
import xyz.wagyourtail.jvmdg.shade.asm.Opcodes;
import xyz.wagyourtail.jvmdg.shade.asm.Type;
import xyz.wagyourtail.jvmdg.shade.asm.tree.MethodInsnNode;
import xyz.wagyourtail.jvmdg.shade.asm.tree.MethodNode;
import xyz.wagyourtail.jvmdg.shade.asm.tree.TypeInsnNode;
...
public class J_L_I_VarHandle {
    ...
    public final void set(Object value) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isStatic && type.isPrimitive()) {
            if (type == boolean.class) { set(((Boolean) value).booleanValue()); return; }
            if (type == byte.class) { set(((Number) value).byteValue()); return; }
            if (type == char.class) { set(((Character) value).charValue()); return; }
            if (type == short.class) { set(((Number) value).shortValue()); return; }
            if (type == int.class) { set(((Number) value).intValue()); return; }
            if (type == long.class) { set(((Number) value).longValue()); return; }
            if (type == float.class) { set(((Number) value).floatValue()); return; }
            if (type == double.class) { set(((Number) value).doubleValue()); return; }
        }
        // jvmdg-fix end
        checkStatic(Object.class);
    ...
    public final void set(Object owner, Object value) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (!isArray && !isStatic && type.isPrimitive()) {
            if (type == boolean.class) { set(owner, ((Boolean) value).booleanValue()); return; }
            if (type == byte.class) { set(owner, ((Number) value).byteValue()); return; }
            if (type == char.class) { set(owner, ((Character) value).charValue()); return; }
            if (type == short.class) { set(owner, ((Number) value).shortValue()); return; }
            if (type == int.class) { set(owner, ((Number) value).intValue()); return; }
            if (type == long.class) { set(owner, ((Number) value).longValue()); return; }
            if (type == float.class) { set(owner, ((Number) value).floatValue()); return; }
            if (type == double.class) { set(owner, ((Number) value).doubleValue()); return; }
        }
        // jvmdg-fix end
        checkOwner(owner, Object.class);
    ...
    public final void set(Object owner, int index, Object value) {
        ...
        if (isArray && type.isPrimitive()) {
            if (type == boolean.class) { set(owner, index, ((Boolean) value).booleanValue()); return; }
            if (type == byte.class) { set(owner, index, ((Number) value).byteValue()); return; }
            if (type == char.class) { set(owner, index, ((Character) value).charValue()); return; }
            if (type == short.class) { set(owner, index, ((Number) value).shortValue()); return; }
            if (type == int.class) { set(owner, index, ((Number) value).intValue()); return; }
            if (type == long.class) { set(owner, index, ((Number) value).longValue()); return; }
            if (type == float.class) { set(owner, index, ((Number) value).floatValue()); return; }
            if (type == double.class) { set(owner, index, ((Number) value).doubleValue()); return; }
        }
        // jvmdg-fix end
        checkArray(owner, index, Object.class);
    ...
    public final void setVolatile(Object value) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isStatic && type.isPrimitive()) {
            if (type == boolean.class) { setVolatile(((Boolean) value).booleanValue()); return; }
            if (type == byte.class) { setVolatile(((Number) value).byteValue()); return; }
            if (type == char.class) { setVolatile(((Character) value).charValue()); return; }
            if (type == short.class) { setVolatile(((Number) value).shortValue()); return; }
            if (type == int.class) { setVolatile(((Number) value).intValue()); return; }
            if (type == long.class) { setVolatile(((Number) value).longValue()); return; }
            if (type == float.class) { setVolatile(((Number) value).floatValue()); return; }
            if (type == double.class) { setVolatile(((Number) value).doubleValue()); return; }
        }
        // jvmdg-fix end
        checkStatic(Object.class);
    ...
    public final void setVolatile(Object owner, Object value) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (!isArray && !isStatic && type.isPrimitive()) {
            if (type == boolean.class) { setVolatile(owner, ((Boolean) value).booleanValue()); return; }
            if (type == byte.class) { setVolatile(owner, ((Number) value).byteValue()); return; }
            if (type == char.class) { setVolatile(owner, ((Character) value).charValue()); return; }
            if (type == short.class) { setVolatile(owner, ((Number) value).shortValue()); return; }
            if (type == int.class) { setVolatile(owner, ((Number) value).intValue()); return; }
            if (type == long.class) { setVolatile(owner, ((Number) value).longValue()); return; }
            if (type == float.class) { setVolatile(owner, ((Number) value).floatValue()); return; }
            if (type == double.class) { setVolatile(owner, ((Number) value).doubleValue()); return; }
        }
        // jvmdg-fix end
        checkOwner(owner, Object.class);
    ...
    public final void setVolatile(Object owner, int index, Object value) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isArray && type.isPrimitive()) {
            if (type == boolean.class) { setVolatile(owner, index, ((Boolean) value).booleanValue()); return; }
            if (type == byte.class) { setVolatile(owner, index, ((Number) value).byteValue()); return; }
            if (type == char.class) { setVolatile(owner, index, ((Character) value).charValue()); return; }
            if (type == short.class) { setVolatile(owner, index, ((Number) value).shortValue()); return; }
            if (type == int.class) { setVolatile(owner, index, ((Number) value).intValue()); return; }
            if (type == long.class) { setVolatile(owner, index, ((Number) value).longValue()); return; }
            if (type == float.class) { setVolatile(owner, index, ((Number) value).floatValue()); return; }
            if (type == double.class) { setVolatile(owner, index, ((Number) value).doubleValue()); return; }
        }
        // jvmdg-fix end
        checkArray(owner, index, Object.class);
    ...
    public final void setOpaque(Object value) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isStatic && type.isPrimitive()) {
            if (type == boolean.class) { setOpaque(((Boolean) value).booleanValue()); return; }
            if (type == byte.class) { setOpaque(((Number) value).byteValue()); return; }
            if (type == char.class) { setOpaque(((Character) value).charValue()); return; }
            if (type == short.class) { setOpaque(((Number) value).shortValue()); return; }
            if (type == int.class) { setOpaque(((Number) value).intValue()); return; }
            if (type == long.class) { setOpaque(((Number) value).longValue()); return; }
            if (type == float.class) { setOpaque(((Number) value).floatValue()); return; }
            if (type == double.class) { setOpaque(((Number) value).doubleValue()); return; }
        }
        // jvmdg-fix end
        checkStatic(Object.class);
        unsafe.putObjectVolatile(staticFieldBase, fieldOffset, value);
    ...
    public final void setOpaque(Object owner, Object value) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (!isArray && !isStatic && type.isPrimitive()) {
            if (type == boolean.class) { setOpaque(owner, ((Boolean) value).booleanValue()); return; }
            if (type == byte.class) { setOpaque(owner, ((Number) value).byteValue()); return; }
            if (type == char.class) { setOpaque(owner, ((Character) value).charValue()); return; }
            if (type == short.class) { setOpaque(owner, ((Number) value).shortValue()); return; }
            if (type == int.class) { setOpaque(owner, ((Number) value).intValue()); return; }
            if (type == long.class) { setOpaque(owner, ((Number) value).longValue()); return; }
            if (type == float.class) { setOpaque(owner, ((Number) value).floatValue()); return; }
            if (type == double.class) { setOpaque(owner, ((Number) value).doubleValue()); return; }
        }
        // jvmdg-fix end
        checkOwner(owner, Object.class);
        unsafe.putObjectVolatile(owner, fieldOffset, value);
    ...
    public final void setOpaque(Object owner, int index, Object value) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isArray && type.isPrimitive()) {
            if (type == boolean.class) { setOpaque(owner, index, ((Boolean) value).booleanValue()); return; }
            if (type == byte.class) { setOpaque(owner, index, ((Number) value).byteValue()); return; }
            if (type == char.class) { setOpaque(owner, index, ((Character) value).charValue()); return; }
            if (type == short.class) { setOpaque(owner, index, ((Number) value).shortValue()); return; }
            if (type == int.class) { setOpaque(owner, index, ((Number) value).intValue()); return; }
            if (type == long.class) { setOpaque(owner, index, ((Number) value).longValue()); return; }
            if (type == float.class) { setOpaque(owner, index, ((Number) value).floatValue()); return; }
            if (type == double.class) { setOpaque(owner, index, ((Number) value).doubleValue()); return; }
        }
        // jvmdg-fix end
        checkArray(owner, index, Object.class);
        unsafe.putObjectVolatile(owner, fieldOffset + index * arrayIndexScale, value);
    ...
    public final Object getAcquire() {
        // jvmdg-fix - getVolatile() below dispatches and checks by actual type
    ...
    public final Object getAcquire(Object owner) {
        // jvmdg-fix - getVolatile(owner) below dispatches and checks by actual type
    ...
    public final Object getAcquire(Object owner, int index) {
        // jvmdg-fix - getVolatile(owner, index) below dispatches and checks by actual type
    ...
    public final void setRelease(Object value) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isStatic && type.isPrimitive()) {
            if (type == boolean.class) { setRelease(((Boolean) value).booleanValue()); return; }
            if (type == byte.class) { setRelease(((Number) value).byteValue()); return; }
            if (type == char.class) { setRelease(((Character) value).charValue()); return; }
            if (type == short.class) { setRelease(((Number) value).shortValue()); return; }
            if (type == int.class) { setRelease(((Number) value).intValue()); return; }
            if (type == long.class) { setRelease(((Number) value).longValue()); return; }
            if (type == float.class) { setRelease(((Number) value).floatValue()); return; }
            if (type == double.class) { setRelease(((Number) value).doubleValue()); return; }
        }
        // jvmdg-fix end
        checkStatic(Object.class);
        unsafe.fullFence();
    ...
    public final void setRelease(Object owner, Object value) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (!isArray && !isStatic && type.isPrimitive()) {
            if (type == boolean.class) { setRelease(owner, ((Boolean) value).booleanValue()); return; }
            if (type == byte.class) { setRelease(owner, ((Number) value).byteValue()); return; }
            if (type == char.class) { setRelease(owner, ((Character) value).charValue()); return; }
            if (type == short.class) { setRelease(owner, ((Number) value).shortValue()); return; }
            if (type == int.class) { setRelease(owner, ((Number) value).intValue()); return; }
            if (type == long.class) { setRelease(owner, ((Number) value).longValue()); return; }
            if (type == float.class) { setRelease(owner, ((Number) value).floatValue()); return; }
            if (type == double.class) { setRelease(owner, ((Number) value).doubleValue()); return; }
        }
        // jvmdg-fix end
        checkOwner(owner, Object.class);
        unsafe.fullFence();
    ...
    public final void setRelease(Object owner, int index, Object value) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isArray && type.isPrimitive()) {
            if (type == boolean.class) { setRelease(owner, index, ((Boolean) value).booleanValue()); return; }
            if (type == byte.class) { setRelease(owner, index, ((Number) value).byteValue()); return; }
            if (type == char.class) { setRelease(owner, index, ((Character) value).charValue()); return; }
            if (type == short.class) { setRelease(owner, index, ((Number) value).shortValue()); return; }
            if (type == int.class) { setRelease(owner, index, ((Number) value).intValue()); return; }
            if (type == long.class) { setRelease(owner, index, ((Number) value).longValue()); return; }
            if (type == float.class) { setRelease(owner, index, ((Number) value).floatValue()); return; }
            if (type == double.class) { setRelease(owner, index, ((Number) value).doubleValue()); return; }
        }
        // jvmdg-fix end
        checkArray(owner, index, Object.class);
        unsafe.fullFence();
    ...
    public final boolean compareAndSet(Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isStatic && type.isPrimitive()) {
            if (type == boolean.class) return compareAndSet(((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return compareAndSet(((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return compareAndSet(((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return compareAndSet(((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return compareAndSet(((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return compareAndSet(((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return compareAndSet(((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return compareAndSet(((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
        checkStatic(Object.class);
    ...
    public final boolean compareAndSet(boolean expected, boolean newValue) {
        checkStatic(boolean.class);
        return jvmdgSubWordCas(staticFieldBase, fieldOffset, 0, (expected ? 1 : 0), (newValue ? 1 : 0), false) == (expected ? 1 : 0);
    }

    public final boolean compareAndSet(byte expected, byte newValue) {
        checkStatic(byte.class);
        return jvmdgSubWordCas(staticFieldBase, fieldOffset, 1, (expected & 0xFF), (newValue & 0xFF), false) == (expected & 0xFF);
    }

    public final boolean compareAndSet(char expected, char newValue) {
        checkStatic(char.class);
        return jvmdgSubWordCas(staticFieldBase, fieldOffset, 2, expected, newValue, false) == expected;
    }

    public final boolean compareAndSet(short expected, short newValue) {
        checkStatic(short.class);
        return jvmdgSubWordCas(staticFieldBase, fieldOffset, 3, (expected & 0xFFFF), (newValue & 0xFFFF), false) == (expected & 0xFFFF);
    }
    ...
    public final boolean compareAndSet(Object owner, Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (!isArray && !isStatic && type.isPrimitive()) {
            if (type == boolean.class) return compareAndSet(owner, ((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return compareAndSet(owner, ((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return compareAndSet(owner, ((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return compareAndSet(owner, ((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return compareAndSet(owner, ((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return compareAndSet(owner, ((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return compareAndSet(owner, ((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return compareAndSet(owner, ((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
        checkOwner(owner, Object.class);
    ...
    public final boolean compareAndSet(Object owner, boolean expected, boolean newValue) {
        checkOwner(owner, boolean.class);
        return jvmdgSubWordCas(owner, fieldOffset, 0, (expected ? 1 : 0), (newValue ? 1 : 0), false) == (expected ? 1 : 0);
    }

    public final boolean compareAndSet(Object owner, byte expected, byte newValue) {
        checkOwner(owner, byte.class);
        return jvmdgSubWordCas(owner, fieldOffset, 1, (expected & 0xFF), (newValue & 0xFF), false) == (expected & 0xFF);
    }

    public final boolean compareAndSet(Object owner, char expected, char newValue) {
        checkOwner(owner, char.class);
        return jvmdgSubWordCas(owner, fieldOffset, 2, expected, newValue, false) == expected;
    }

    public final boolean compareAndSet(Object owner, short expected, short newValue) {
        checkOwner(owner, short.class);
        return jvmdgSubWordCas(owner, fieldOffset, 3, (expected & 0xFFFF), (newValue & 0xFFFF), false) == (expected & 0xFFFF);
    }
    ...
    public final boolean compareAndSet(Object owner, int index, Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isArray && type.isPrimitive()) {
            if (type == boolean.class) return compareAndSet(owner, index, ((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return compareAndSet(owner, index, ((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return compareAndSet(owner, index, ((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return compareAndSet(owner, index, ((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return compareAndSet(owner, index, ((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return compareAndSet(owner, index, ((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return compareAndSet(owner, index, ((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return compareAndSet(owner, index, ((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
        checkArray(owner, index, Object.class);
    ...
    public final boolean compareAndSet(Object owner, int index, boolean expected, boolean newValue) {
        checkArray(owner, index, boolean.class);
        return jvmdgSubWordCas(owner, fieldOffset + index * arrayIndexScale, 0, (expected ? 1 : 0), (newValue ? 1 : 0), false) == (expected ? 1 : 0);
    }

    public final boolean compareAndSet(Object owner, int index, byte expected, byte newValue) {
        checkArray(owner, index, byte.class);
        return jvmdgSubWordCas(owner, fieldOffset + index * arrayIndexScale, 1, (expected & 0xFF), (newValue & 0xFF), false) == (expected & 0xFF);
    }

    public final boolean compareAndSet(Object owner, int index, char expected, char newValue) {
        checkArray(owner, index, char.class);
        return jvmdgSubWordCas(owner, fieldOffset + index * arrayIndexScale, 2, expected, newValue, false) == expected;
    }

    public final boolean compareAndSet(Object owner, int index, short expected, short newValue) {
        checkArray(owner, index, short.class);
        return jvmdgSubWordCas(owner, fieldOffset + index * arrayIndexScale, 3, (expected & 0xFFFF), (newValue & 0xFFFF), false) == (expected & 0xFFFF);
    }
    ...
    public final Object compareAndExchange(Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isStatic && type.isPrimitive()) {
            if (type == boolean.class) return compareAndExchange(((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return compareAndExchange(((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return compareAndExchange(((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return compareAndExchange(((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return compareAndExchange(((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return compareAndExchange(((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return compareAndExchange(((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return compareAndExchange(((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
        checkStatic(Object.class);
        Object v;
    ...
    public final boolean compareAndExchange(boolean expected, boolean newValue) {
        checkStatic(boolean.class);
        return (jvmdgSubWordCas(staticFieldBase, fieldOffset, 0, (expected ? 1 : 0), (newValue ? 1 : 0), false)) != 0;
    }

    public final byte compareAndExchange(byte expected, byte newValue) {
        checkStatic(byte.class);
        return (byte) (jvmdgSubWordCas(staticFieldBase, fieldOffset, 1, (expected & 0xFF), (newValue & 0xFF), false));
    }

    public final char compareAndExchange(char expected, char newValue) {
        checkStatic(char.class);
        return (char) (jvmdgSubWordCas(staticFieldBase, fieldOffset, 2, expected, newValue, false));
    }

    public final short compareAndExchange(short expected, short newValue) {
        checkStatic(short.class);
        return (short) (jvmdgSubWordCas(staticFieldBase, fieldOffset, 3, (expected & 0xFFFF), (newValue & 0xFFFF), false));
    }
    ...
    public final Object compareAndExchange(Object owner, Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (!isArray && !isStatic && type.isPrimitive()) {
            if (type == boolean.class) return compareAndExchange(owner, ((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return compareAndExchange(owner, ((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return compareAndExchange(owner, ((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return compareAndExchange(owner, ((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return compareAndExchange(owner, ((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return compareAndExchange(owner, ((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return compareAndExchange(owner, ((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return compareAndExchange(owner, ((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
        checkOwner(owner, Object.class);
        Object v;
    ...
    public final boolean compareAndExchange(Object owner, boolean expected, boolean newValue) {
        checkOwner(owner, boolean.class);
        return (jvmdgSubWordCas(owner, fieldOffset, 0, (expected ? 1 : 0), (newValue ? 1 : 0), false)) != 0;
    }

    public final byte compareAndExchange(Object owner, byte expected, byte newValue) {
        checkOwner(owner, byte.class);
        return (byte) (jvmdgSubWordCas(owner, fieldOffset, 1, (expected & 0xFF), (newValue & 0xFF), false));
    }

    public final char compareAndExchange(Object owner, char expected, char newValue) {
        checkOwner(owner, char.class);
        return (char) (jvmdgSubWordCas(owner, fieldOffset, 2, expected, newValue, false));
    }

    public final short compareAndExchange(Object owner, short expected, short newValue) {
        checkOwner(owner, short.class);
        return (short) (jvmdgSubWordCas(owner, fieldOffset, 3, (expected & 0xFFFF), (newValue & 0xFFFF), false));
    }
    ...
    public final Object compareAndExchange(Object owner, int index, Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isArray && type.isPrimitive()) {
            if (type == boolean.class) return compareAndExchange(owner, index, ((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return compareAndExchange(owner, index, ((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return compareAndExchange(owner, index, ((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return compareAndExchange(owner, index, ((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return compareAndExchange(owner, index, ((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return compareAndExchange(owner, index, ((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return compareAndExchange(owner, index, ((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return compareAndExchange(owner, index, ((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
        checkArray(owner, index, Object.class);
        Object v;
    ...
    public final boolean compareAndExchange(Object owner, int index, boolean expected, boolean newValue) {
        checkArray(owner, index, boolean.class);
        return (jvmdgSubWordCas(owner, fieldOffset + index * arrayIndexScale, 0, (expected ? 1 : 0), (newValue ? 1 : 0), false)) != 0;
    }

    public final byte compareAndExchange(Object owner, int index, byte expected, byte newValue) {
        checkArray(owner, index, byte.class);
        return (byte) (jvmdgSubWordCas(owner, fieldOffset + index * arrayIndexScale, 1, (expected & 0xFF), (newValue & 0xFF), false));
    }

    public final char compareAndExchange(Object owner, int index, char expected, char newValue) {
        checkArray(owner, index, char.class);
        return (char) (jvmdgSubWordCas(owner, fieldOffset + index * arrayIndexScale, 2, expected, newValue, false));
    }

    public final short compareAndExchange(Object owner, int index, short expected, short newValue) {
        checkArray(owner, index, short.class);
        return (short) (jvmdgSubWordCas(owner, fieldOffset + index * arrayIndexScale, 3, (expected & 0xFFFF), (newValue & 0xFFFF), false));
    }
    ...
    public final Object compareAndExchangeAcquire(Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isStatic && type.isPrimitive()) {
            if (type == boolean.class) return compareAndExchangeAcquire(((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return compareAndExchangeAcquire(((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return compareAndExchangeAcquire(((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return compareAndExchangeAcquire(((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return compareAndExchangeAcquire(((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return compareAndExchangeAcquire(((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return compareAndExchangeAcquire(((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return compareAndExchangeAcquire(((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
    ...
    public final Object compareAndExchangeAcquire(Object owner, Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (!isArray && !isStatic && type.isPrimitive()) {
            if (type == boolean.class) return compareAndExchangeAcquire(owner, ((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return compareAndExchangeAcquire(owner, ((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return compareAndExchangeAcquire(owner, ((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return compareAndExchangeAcquire(owner, ((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return compareAndExchangeAcquire(owner, ((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return compareAndExchangeAcquire(owner, ((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return compareAndExchangeAcquire(owner, ((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return compareAndExchangeAcquire(owner, ((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
    ...
    public final Object compareAndExchangeAcquire(Object owner, int index, Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isArray && type.isPrimitive()) {
            if (type == boolean.class) return compareAndExchangeAcquire(owner, index, ((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return compareAndExchangeAcquire(owner, index, ((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return compareAndExchangeAcquire(owner, index, ((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return compareAndExchangeAcquire(owner, index, ((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return compareAndExchangeAcquire(owner, index, ((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return compareAndExchangeAcquire(owner, index, ((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return compareAndExchangeAcquire(owner, index, ((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return compareAndExchangeAcquire(owner, index, ((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
    ...
    public final Object compareAndExchangeRelease(Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isStatic && type.isPrimitive()) {
            if (type == boolean.class) return compareAndExchangeRelease(((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return compareAndExchangeRelease(((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return compareAndExchangeRelease(((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return compareAndExchangeRelease(((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return compareAndExchangeRelease(((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return compareAndExchangeRelease(((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return compareAndExchangeRelease(((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return compareAndExchangeRelease(((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
        unsafe.fullFence();
    ...
    public final Object compareAndExchangeRelease(Object owner, Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (!isArray && !isStatic && type.isPrimitive()) {
            if (type == boolean.class) return compareAndExchangeRelease(owner, ((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return compareAndExchangeRelease(owner, ((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return compareAndExchangeRelease(owner, ((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return compareAndExchangeRelease(owner, ((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return compareAndExchangeRelease(owner, ((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return compareAndExchangeRelease(owner, ((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return compareAndExchangeRelease(owner, ((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return compareAndExchangeRelease(owner, ((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
        unsafe.fullFence();
    ...
    public final Object compareAndExchangeRelease(Object owner, int index, Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isArray && type.isPrimitive()) {
            if (type == boolean.class) return compareAndExchangeRelease(owner, index, ((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return compareAndExchangeRelease(owner, index, ((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return compareAndExchangeRelease(owner, index, ((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return compareAndExchangeRelease(owner, index, ((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return compareAndExchangeRelease(owner, index, ((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return compareAndExchangeRelease(owner, index, ((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return compareAndExchangeRelease(owner, index, ((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return compareAndExchangeRelease(owner, index, ((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
        unsafe.fullFence();
    ...
    public final boolean weakCompareAndSetPlain(Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isStatic && type.isPrimitive()) {
            if (type == boolean.class) return weakCompareAndSetPlain(((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return weakCompareAndSetPlain(((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return weakCompareAndSetPlain(((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return weakCompareAndSetPlain(((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return weakCompareAndSetPlain(((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return weakCompareAndSetPlain(((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return weakCompareAndSetPlain(((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return weakCompareAndSetPlain(((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
    ...
    public final boolean weakCompareAndSetPlain(Object owner, Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (!isArray && !isStatic && type.isPrimitive()) {
            if (type == boolean.class) return weakCompareAndSetPlain(owner, ((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return weakCompareAndSetPlain(owner, ((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return weakCompareAndSetPlain(owner, ((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return weakCompareAndSetPlain(owner, ((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return weakCompareAndSetPlain(owner, ((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return weakCompareAndSetPlain(owner, ((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return weakCompareAndSetPlain(owner, ((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return weakCompareAndSetPlain(owner, ((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
    ...
    public final boolean weakCompareAndSetPlain(Object owner, int index, Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isArray && type.isPrimitive()) {
            if (type == boolean.class) return weakCompareAndSetPlain(owner, index, ((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return weakCompareAndSetPlain(owner, index, ((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return weakCompareAndSetPlain(owner, index, ((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return weakCompareAndSetPlain(owner, index, ((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return weakCompareAndSetPlain(owner, index, ((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return weakCompareAndSetPlain(owner, index, ((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return weakCompareAndSetPlain(owner, index, ((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return weakCompareAndSetPlain(owner, index, ((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
    ...
    public final boolean weakCompareAndSet(Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isStatic && type.isPrimitive()) {
            if (type == boolean.class) return weakCompareAndSet(((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return weakCompareAndSet(((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return weakCompareAndSet(((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return weakCompareAndSet(((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return weakCompareAndSet(((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return weakCompareAndSet(((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return weakCompareAndSet(((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return weakCompareAndSet(((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
        return compareAndSet(expected, newValue);
    }
    ...
    public final boolean weakCompareAndSet(Object owner, Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (!isArray && !isStatic && type.isPrimitive()) {
            if (type == boolean.class) return weakCompareAndSet(owner, ((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return weakCompareAndSet(owner, ((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return weakCompareAndSet(owner, ((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return weakCompareAndSet(owner, ((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return weakCompareAndSet(owner, ((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return weakCompareAndSet(owner, ((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return weakCompareAndSet(owner, ((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return weakCompareAndSet(owner, ((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
        return compareAndSet(owner, expected, newValue);
    }
    ...
    public final boolean weakCompareAndSet(Object owner, int index, Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isArray && type.isPrimitive()) {
            if (type == boolean.class) return weakCompareAndSet(owner, index, ((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return weakCompareAndSet(owner, index, ((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return weakCompareAndSet(owner, index, ((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return weakCompareAndSet(owner, index, ((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return weakCompareAndSet(owner, index, ((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return weakCompareAndSet(owner, index, ((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return weakCompareAndSet(owner, index, ((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return weakCompareAndSet(owner, index, ((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
        return compareAndSet(owner, index, expected, newValue);
    }
    ...
    public final boolean weakCompareAndSetAcquire(Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isStatic && type.isPrimitive()) {
            if (type == boolean.class) return weakCompareAndSetAcquire(((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return weakCompareAndSetAcquire(((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return weakCompareAndSetAcquire(((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return weakCompareAndSetAcquire(((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return weakCompareAndSetAcquire(((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return weakCompareAndSetAcquire(((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return weakCompareAndSetAcquire(((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return weakCompareAndSetAcquire(((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
    ...
    public final boolean weakCompareAndSetAcquire(Object owner, Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (!isArray && !isStatic && type.isPrimitive()) {
            if (type == boolean.class) return weakCompareAndSetAcquire(owner, ((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return weakCompareAndSetAcquire(owner, ((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return weakCompareAndSetAcquire(owner, ((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return weakCompareAndSetAcquire(owner, ((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return weakCompareAndSetAcquire(owner, ((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return weakCompareAndSetAcquire(owner, ((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return weakCompareAndSetAcquire(owner, ((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return weakCompareAndSetAcquire(owner, ((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
    ...
    public final boolean weakCompareAndSetAcquire(Object owner, int index, Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isArray && type.isPrimitive()) {
            if (type == boolean.class) return weakCompareAndSetAcquire(owner, index, ((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return weakCompareAndSetAcquire(owner, index, ((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return weakCompareAndSetAcquire(owner, index, ((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return weakCompareAndSetAcquire(owner, index, ((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return weakCompareAndSetAcquire(owner, index, ((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return weakCompareAndSetAcquire(owner, index, ((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return weakCompareAndSetAcquire(owner, index, ((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return weakCompareAndSetAcquire(owner, index, ((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
    ...
    public final boolean weakCompareAndSetRelease(Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isStatic && type.isPrimitive()) {
            if (type == boolean.class) return weakCompareAndSetRelease(((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return weakCompareAndSetRelease(((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return weakCompareAndSetRelease(((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return weakCompareAndSetRelease(((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return weakCompareAndSetRelease(((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return weakCompareAndSetRelease(((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return weakCompareAndSetRelease(((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return weakCompareAndSetRelease(((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
        unsafe.fullFence();
        return compareAndSet(expected, newValue);
    ...
    public final boolean weakCompareAndSetRelease(Object owner, Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (!isArray && !isStatic && type.isPrimitive()) {
            if (type == boolean.class) return weakCompareAndSetRelease(owner, ((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return weakCompareAndSetRelease(owner, ((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return weakCompareAndSetRelease(owner, ((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return weakCompareAndSetRelease(owner, ((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return weakCompareAndSetRelease(owner, ((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return weakCompareAndSetRelease(owner, ((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return weakCompareAndSetRelease(owner, ((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return weakCompareAndSetRelease(owner, ((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
        unsafe.fullFence();
        return compareAndSet(owner, expected, newValue);
    ...
    public final boolean weakCompareAndSetRelease(Object owner, int index, Object expected, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isArray && type.isPrimitive()) {
            if (type == boolean.class) return weakCompareAndSetRelease(owner, index, ((Boolean) expected).booleanValue(), ((Boolean) newValue).booleanValue());
            if (type == byte.class) return weakCompareAndSetRelease(owner, index, ((Number) expected).byteValue(), ((Number) newValue).byteValue());
            if (type == char.class) return weakCompareAndSetRelease(owner, index, ((Character) expected).charValue(), ((Character) newValue).charValue());
            if (type == short.class) return weakCompareAndSetRelease(owner, index, ((Number) expected).shortValue(), ((Number) newValue).shortValue());
            if (type == int.class) return weakCompareAndSetRelease(owner, index, ((Number) expected).intValue(), ((Number) newValue).intValue());
            if (type == long.class) return weakCompareAndSetRelease(owner, index, ((Number) expected).longValue(), ((Number) newValue).longValue());
            if (type == float.class) return weakCompareAndSetRelease(owner, index, ((Number) expected).floatValue(), ((Number) newValue).floatValue());
            if (type == double.class) return weakCompareAndSetRelease(owner, index, ((Number) expected).doubleValue(), ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
        unsafe.fullFence();
        return compareAndSet(owner, index, expected, newValue);
    ...
    public final boolean getAndSet(boolean newValue) {
        checkStatic(boolean.class);
        return (jvmdgSubWordCas(staticFieldBase, fieldOffset, 0, 0, (newValue ? 1 : 0), true)) != 0;
    }

    public final byte getAndSet(byte newValue) {
        checkStatic(byte.class);
        return (byte) (jvmdgSubWordCas(staticFieldBase, fieldOffset, 1, 0, (newValue & 0xFF), true));
    }

    public final char getAndSet(char newValue) {
        checkStatic(char.class);
        return (char) (jvmdgSubWordCas(staticFieldBase, fieldOffset, 2, 0, newValue, true));
    }

    public final short getAndSet(short newValue) {
        checkStatic(short.class);
        return (short) (jvmdgSubWordCas(staticFieldBase, fieldOffset, 3, 0, (newValue & 0xFFFF), true));
    }
    ...
    public final Object getAndSet(Object owner, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (!isArray && !isStatic && type.isPrimitive()) {
            if (type == boolean.class) return getAndSet(owner, ((Boolean) newValue).booleanValue());
            if (type == byte.class) return getAndSet(owner, ((Number) newValue).byteValue());
            if (type == char.class) return getAndSet(owner, ((Character) newValue).charValue());
            if (type == short.class) return getAndSet(owner, ((Number) newValue).shortValue());
            if (type == int.class) return getAndSet(owner, ((Number) newValue).intValue());
            if (type == long.class) return getAndSet(owner, ((Number) newValue).longValue());
            if (type == float.class) return getAndSet(owner, ((Number) newValue).floatValue());
            if (type == double.class) return getAndSet(owner, ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
        checkOwner(owner, Object.class);
    ...
    public final boolean getAndSet(Object owner, boolean newValue) {
        checkOwner(owner, boolean.class);
        return (jvmdgSubWordCas(owner, fieldOffset, 0, 0, (newValue ? 1 : 0), true)) != 0;
    }

    public final byte getAndSet(Object owner, byte newValue) {
        checkOwner(owner, byte.class);
        return (byte) (jvmdgSubWordCas(owner, fieldOffset, 1, 0, (newValue & 0xFF), true));
    }

    public final char getAndSet(Object owner, char newValue) {
        checkOwner(owner, char.class);
        return (char) (jvmdgSubWordCas(owner, fieldOffset, 2, 0, newValue, true));
    }

    public final short getAndSet(Object owner, short newValue) {
        checkOwner(owner, short.class);
        return (short) (jvmdgSubWordCas(owner, fieldOffset, 3, 0, (newValue & 0xFFFF), true));
    }
    ...
    public final Object getAndSet(Object owner, int index, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isArray && type.isPrimitive()) {
            if (type == boolean.class) return getAndSet(owner, index, ((Boolean) newValue).booleanValue());
            if (type == byte.class) return getAndSet(owner, index, ((Number) newValue).byteValue());
            if (type == char.class) return getAndSet(owner, index, ((Character) newValue).charValue());
            if (type == short.class) return getAndSet(owner, index, ((Number) newValue).shortValue());
            if (type == int.class) return getAndSet(owner, index, ((Number) newValue).intValue());
            if (type == long.class) return getAndSet(owner, index, ((Number) newValue).longValue());
            if (type == float.class) return getAndSet(owner, index, ((Number) newValue).floatValue());
            if (type == double.class) return getAndSet(owner, index, ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
        checkArray(owner, index, Object.class);
    ...
    public final boolean getAndSet(Object owner, int index, boolean newValue) {
        checkArray(owner, index, boolean.class);
        return (jvmdgSubWordCas(owner, fieldOffset + index * arrayIndexScale, 0, 0, (newValue ? 1 : 0), true)) != 0;
    }

    public final byte getAndSet(Object owner, int index, byte newValue) {
        checkArray(owner, index, byte.class);
        return (byte) (jvmdgSubWordCas(owner, fieldOffset + index * arrayIndexScale, 1, 0, (newValue & 0xFF), true));
    }

    public final char getAndSet(Object owner, int index, char newValue) {
        checkArray(owner, index, char.class);
        return (char) (jvmdgSubWordCas(owner, fieldOffset + index * arrayIndexScale, 2, 0, newValue, true));
    }

    public final short getAndSet(Object owner, int index, short newValue) {
        checkArray(owner, index, short.class);
        return (short) (jvmdgSubWordCas(owner, fieldOffset + index * arrayIndexScale, 3, 0, (newValue & 0xFFFF), true));
    }
    ...
    public final Object getAndSetAcquire(Object owner, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (!isArray && !isStatic && type.isPrimitive()) {
            if (type == boolean.class) return getAndSetAcquire(owner, ((Boolean) newValue).booleanValue());
            if (type == byte.class) return getAndSetAcquire(owner, ((Number) newValue).byteValue());
            if (type == char.class) return getAndSetAcquire(owner, ((Character) newValue).charValue());
            if (type == short.class) return getAndSetAcquire(owner, ((Number) newValue).shortValue());
            if (type == int.class) return getAndSetAcquire(owner, ((Number) newValue).intValue());
            if (type == long.class) return getAndSetAcquire(owner, ((Number) newValue).longValue());
            if (type == float.class) return getAndSetAcquire(owner, ((Number) newValue).floatValue());
            if (type == double.class) return getAndSetAcquire(owner, ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
    ...
    public final Object getAndSetAcquire(Object owner, int index, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isArray && type.isPrimitive()) {
            if (type == boolean.class) return getAndSetAcquire(owner, index, ((Boolean) newValue).booleanValue());
            if (type == byte.class) return getAndSetAcquire(owner, index, ((Number) newValue).byteValue());
            if (type == char.class) return getAndSetAcquire(owner, index, ((Character) newValue).charValue());
            if (type == short.class) return getAndSetAcquire(owner, index, ((Number) newValue).shortValue());
            if (type == int.class) return getAndSetAcquire(owner, index, ((Number) newValue).intValue());
            if (type == long.class) return getAndSetAcquire(owner, index, ((Number) newValue).longValue());
            if (type == float.class) return getAndSetAcquire(owner, index, ((Number) newValue).floatValue());
            if (type == double.class) return getAndSetAcquire(owner, index, ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
    ...
    public final Object getAndSetRelease(Object owner, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (!isArray && !isStatic && type.isPrimitive()) {
            if (type == boolean.class) return getAndSetRelease(owner, ((Boolean) newValue).booleanValue());
            if (type == byte.class) return getAndSetRelease(owner, ((Number) newValue).byteValue());
            if (type == char.class) return getAndSetRelease(owner, ((Character) newValue).charValue());
            if (type == short.class) return getAndSetRelease(owner, ((Number) newValue).shortValue());
            if (type == int.class) return getAndSetRelease(owner, ((Number) newValue).intValue());
            if (type == long.class) return getAndSetRelease(owner, ((Number) newValue).longValue());
            if (type == float.class) return getAndSetRelease(owner, ((Number) newValue).floatValue());
            if (type == double.class) return getAndSetRelease(owner, ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
        unsafe.fullFence();
    ...
    public final Object getAndSetRelease(Object owner, int index, Object newValue) {
        // jvmdg-fix start - primitive-typed handles accept boxed values (VarHandle non-exact invoke semantics)
        if (isArray && type.isPrimitive()) {
            if (type == boolean.class) return getAndSetRelease(owner, index, ((Boolean) newValue).booleanValue());
            if (type == byte.class) return getAndSetRelease(owner, index, ((Number) newValue).byteValue());
            if (type == char.class) return getAndSetRelease(owner, index, ((Character) newValue).charValue());
            if (type == short.class) return getAndSetRelease(owner, index, ((Number) newValue).shortValue());
            if (type == int.class) return getAndSetRelease(owner, index, ((Number) newValue).intValue());
            if (type == long.class) return getAndSetRelease(owner, index, ((Number) newValue).longValue());
            if (type == float.class) return getAndSetRelease(owner, index, ((Number) newValue).floatValue());
            if (type == double.class) return getAndSetRelease(owner, index, ((Number) newValue).doubleValue());
        }
        // jvmdg-fix end
        unsafe.fullFence();
    ...
    public final byte getAndAdd(byte value) {
        checkStatic(byte.class);
        return (byte) (jvmdgSubWordGetAndOp(staticFieldBase, fieldOffset, 1, (value & 0xFF), 0));
    }

    public final char getAndAdd(char value) {
        checkStatic(char.class);
        return (char) (jvmdgSubWordGetAndOp(staticFieldBase, fieldOffset, 2, value, 0));
    }

    public final short getAndAdd(short value) {
        checkStatic(short.class);
        return (short) (jvmdgSubWordGetAndOp(staticFieldBase, fieldOffset, 3, (value & 0xFFFF), 0));
    }
    ...
    public final byte getAndAdd(Object owner, byte value) {
        checkOwner(owner, byte.class);
        return (byte) (jvmdgSubWordGetAndOp(owner, fieldOffset, 1, (value & 0xFF), 0));
    }

    public final char getAndAdd(Object owner, char value) {
        checkOwner(owner, char.class);
        return (char) (jvmdgSubWordGetAndOp(owner, fieldOffset, 2, value, 0));
    }

    public final short getAndAdd(Object owner, short value) {
        checkOwner(owner, short.class);
        return (short) (jvmdgSubWordGetAndOp(owner, fieldOffset, 3, (value & 0xFFFF), 0));
    }
    ...
    public final byte getAndAdd(Object owner, int index, byte value) {
        checkArray(owner, index, byte.class);
        return (byte) (jvmdgSubWordGetAndOp(owner, fieldOffset + index * arrayIndexScale, 1, (value & 0xFF), 0));
    }

    public final char getAndAdd(Object owner, int index, char value) {
        checkArray(owner, index, char.class);
        return (char) (jvmdgSubWordGetAndOp(owner, fieldOffset + index * arrayIndexScale, 2, value, 0));
    }

    public final short getAndAdd(Object owner, int index, short value) {
        checkArray(owner, index, short.class);
        return (short) (jvmdgSubWordGetAndOp(owner, fieldOffset + index * arrayIndexScale, 3, (value & 0xFFFF), 0));
    }
    ...
    public final boolean getAndBitwiseOr(boolean value) {
        checkStatic(boolean.class);
        return (jvmdgSubWordGetAndOp(staticFieldBase, fieldOffset, 0, (value ? 1 : 0), 1)) != 0;
    }

    public final byte getAndBitwiseOr(byte value) {
        checkStatic(byte.class);
        return (byte) (jvmdgSubWordGetAndOp(staticFieldBase, fieldOffset, 1, (value & 0xFF), 1));
    }

    public final char getAndBitwiseOr(char value) {
        checkStatic(char.class);
        return (char) (jvmdgSubWordGetAndOp(staticFieldBase, fieldOffset, 2, value, 1));
    }

    public final short getAndBitwiseOr(short value) {
        checkStatic(short.class);
        return (short) (jvmdgSubWordGetAndOp(staticFieldBase, fieldOffset, 3, (value & 0xFFFF), 1));
    }
    ...
    public final boolean getAndBitwiseOr(Object owner, boolean value) {
        checkOwner(owner, boolean.class);
        return (jvmdgSubWordGetAndOp(owner, fieldOffset, 0, (value ? 1 : 0), 1)) != 0;
    }

    public final byte getAndBitwiseOr(Object owner, byte value) {
        checkOwner(owner, byte.class);
        return (byte) (jvmdgSubWordGetAndOp(owner, fieldOffset, 1, (value & 0xFF), 1));
    }

    public final char getAndBitwiseOr(Object owner, char value) {
        checkOwner(owner, char.class);
        return (char) (jvmdgSubWordGetAndOp(owner, fieldOffset, 2, value, 1));
    }

    public final short getAndBitwiseOr(Object owner, short value) {
        checkOwner(owner, short.class);
        return (short) (jvmdgSubWordGetAndOp(owner, fieldOffset, 3, (value & 0xFFFF), 1));
    }
    ...
    public final boolean getAndBitwiseOr(Object owner, int index, boolean value) {
        checkArray(owner, index, boolean.class);
        return (jvmdgSubWordGetAndOp(owner, fieldOffset + index * arrayIndexScale, 0, (value ? 1 : 0), 1)) != 0;
    }

    public final byte getAndBitwiseOr(Object owner, int index, byte value) {
        checkArray(owner, index, byte.class);
        return (byte) (jvmdgSubWordGetAndOp(owner, fieldOffset + index * arrayIndexScale, 1, (value & 0xFF), 1));
    }

    public final char getAndBitwiseOr(Object owner, int index, char value) {
        checkArray(owner, index, char.class);
        return (char) (jvmdgSubWordGetAndOp(owner, fieldOffset + index * arrayIndexScale, 2, value, 1));
    }

    public final short getAndBitwiseOr(Object owner, int index, short value) {
        checkArray(owner, index, short.class);
        return (short) (jvmdgSubWordGetAndOp(owner, fieldOffset + index * arrayIndexScale, 3, (value & 0xFFFF), 1));
    }
    ...
    public final boolean getAndBitwiseAnd(boolean value) {
        checkStatic(boolean.class);
        return (jvmdgSubWordGetAndOp(staticFieldBase, fieldOffset, 0, (value ? 1 : 0), 2)) != 0;
    }

    public final byte getAndBitwiseAnd(byte value) {
        checkStatic(byte.class);
        return (byte) (jvmdgSubWordGetAndOp(staticFieldBase, fieldOffset, 1, (value & 0xFF), 2));
    }

    public final char getAndBitwiseAnd(char value) {
        checkStatic(char.class);
        return (char) (jvmdgSubWordGetAndOp(staticFieldBase, fieldOffset, 2, value, 2));
    }

    public final short getAndBitwiseAnd(short value) {
        checkStatic(short.class);
        return (short) (jvmdgSubWordGetAndOp(staticFieldBase, fieldOffset, 3, (value & 0xFFFF), 2));
    }
    ...
    public final boolean getAndBitwiseAnd(Object owner, boolean value) {
        checkOwner(owner, boolean.class);
        return (jvmdgSubWordGetAndOp(owner, fieldOffset, 0, (value ? 1 : 0), 2)) != 0;
    }

    public final byte getAndBitwiseAnd(Object owner, byte value) {
        checkOwner(owner, byte.class);
        return (byte) (jvmdgSubWordGetAndOp(owner, fieldOffset, 1, (value & 0xFF), 2));
    }

    public final char getAndBitwiseAnd(Object owner, char value) {
        checkOwner(owner, char.class);
        return (char) (jvmdgSubWordGetAndOp(owner, fieldOffset, 2, value, 2));
    }

    public final short getAndBitwiseAnd(Object owner, short value) {
        checkOwner(owner, short.class);
        return (short) (jvmdgSubWordGetAndOp(owner, fieldOffset, 3, (value & 0xFFFF), 2));
    }
    ...
    public final boolean getAndBitwiseAnd(Object owner, int index, boolean value) {
        checkArray(owner, index, boolean.class);
        return (jvmdgSubWordGetAndOp(owner, fieldOffset + index * arrayIndexScale, 0, (value ? 1 : 0), 2)) != 0;
    }

    public final byte getAndBitwiseAnd(Object owner, int index, byte value) {
        checkArray(owner, index, byte.class);
        return (byte) (jvmdgSubWordGetAndOp(owner, fieldOffset + index * arrayIndexScale, 1, (value & 0xFF), 2));
    }

    public final char getAndBitwiseAnd(Object owner, int index, char value) {
        checkArray(owner, index, char.class);
        return (char) (jvmdgSubWordGetAndOp(owner, fieldOffset + index * arrayIndexScale, 2, value, 2));
    }

    public final short getAndBitwiseAnd(Object owner, int index, short value) {
        checkArray(owner, index, short.class);
        return (short) (jvmdgSubWordGetAndOp(owner, fieldOffset + index * arrayIndexScale, 3, (value & 0xFFFF), 2));
    }
    ...
    public final boolean getAndBitwiseXor(boolean value) {
        checkStatic(boolean.class);
        return (jvmdgSubWordGetAndOp(staticFieldBase, fieldOffset, 0, (value ? 1 : 0), 3)) != 0;
    }

    public final byte getAndBitwiseXor(byte value) {
        checkStatic(byte.class);
        return (byte) (jvmdgSubWordGetAndOp(staticFieldBase, fieldOffset, 1, (value & 0xFF), 3));
    }

    public final char getAndBitwiseXor(char value) {
        checkStatic(char.class);
        return (char) (jvmdgSubWordGetAndOp(staticFieldBase, fieldOffset, 2, value, 3));
    }


    public final short getAndBitwiseXor(short value) {
        checkStatic(short.class);
        return (short) (jvmdgSubWordGetAndOp(staticFieldBase, fieldOffset, 3, (value & 0xFFFF), 3));
    }
    ...
    public final boolean getAndBitwiseXor(Object owner, boolean value) {
        checkOwner(owner, boolean.class);
        return (jvmdgSubWordGetAndOp(owner, fieldOffset, 0, (value ? 1 : 0), 3)) != 0;
    }

    public final byte getAndBitwiseXor(Object owner, byte value) {
        checkOwner(owner, byte.class);
        return (byte) (jvmdgSubWordGetAndOp(owner, fieldOffset, 1, (value & 0xFF), 3));
    }

    public final char getAndBitwiseXor(Object owner, char value) {
        checkOwner(owner, char.class);
        return (char) (jvmdgSubWordGetAndOp(owner, fieldOffset, 2, value, 3));
    }

    public final short getAndBitwiseXor(Object owner, short value) {
        checkOwner(owner, short.class);
        return (short) (jvmdgSubWordGetAndOp(owner, fieldOffset, 3, (value & 0xFFFF), 3));
    }
    ...
    public final boolean getAndBitwiseXor(Object owner, int index, boolean value) {
        checkArray(owner, index, boolean.class);
        return (jvmdgSubWordGetAndOp(owner, fieldOffset + index * arrayIndexScale, 0, (value ? 1 : 0), 3)) != 0;
    }

    public final byte getAndBitwiseXor(Object owner, int index, byte value) {
        checkArray(owner, index, byte.class);
        return (byte) (jvmdgSubWordGetAndOp(owner, fieldOffset + index * arrayIndexScale, 1, (value & 0xFF), 3));
    }

    public final char getAndBitwiseXor(Object owner, int index, char value) {
        checkArray(owner, index, char.class);
        return (char) (jvmdgSubWordGetAndOp(owner, fieldOffset + index * arrayIndexScale, 2, value, 3));
    }

    public final short getAndBitwiseXor(Object owner, int index, short value) {
        checkArray(owner, index, short.class);
        return (short) (jvmdgSubWordGetAndOp(owner, fieldOffset + index * arrayIndexScale, 3, (value & 0xFFFF), 3));
    }
    ...
    // ==== jvmdg patched: layout-agnostic sub-word (boolean/byte/char/short) atomics ====
    // JDK 8 Unsafe has no sub-word CAS, and Unsafe "offsets" are not guaranteed to be byte addresses on every JVM
    // (e.g. CheerpJ uses logical field slots), so word-masking tricks are unsafe. Instead, use the typed volatile
    // accessors and make read-modify-write sequences atomic with a striped lock keyed by (object, offset).
    private static final Object[] JVMDG_SUBWORD_LOCKS = new Object[512];
    static {
        for (int i = 0; i < JVMDG_SUBWORD_LOCKS.length; i++) JVMDG_SUBWORD_LOCKS[i] = new Object();
    }

    private static Object jvmdgLockFor(Object base, long offset) {
        int h = (base == null ? 0 : System.identityHashCode(base)) * 31 + (int) (offset ^ (offset >>> 32));
        return JVMDG_SUBWORD_LOCKS[(h ^ (h >>> 16)) & (JVMDG_SUBWORD_LOCKS.length - 1)];
    }

    // type codes: 0 boolean, 1 byte, 2 char, 3 short — values are exchanged as int bit patterns
    private int jvmdgReadSubWord(Object base, long offset, int type) {
        switch (type) {
            case 0: return unsafe.getBooleanVolatile(base, offset) ? 1 : 0;
            case 1: return unsafe.getByteVolatile(base, offset) & 0xFF;
            case 2: return unsafe.getCharVolatile(base, offset);
            default: return unsafe.getShortVolatile(base, offset) & 0xFFFF;
        }
    }

    private void jvmdgWriteSubWord(Object base, long offset, int type, int bits) {
        switch (type) {
            case 0: unsafe.putBooleanVolatile(base, offset, bits != 0); break;
            case 1: unsafe.putByteVolatile(base, offset, (byte) bits); break;
            case 2: unsafe.putCharVolatile(base, offset, (char) bits); break;
            default: unsafe.putShortVolatile(base, offset, (short) bits); break;
        }
    }

    /** CAS: returns expectedBits on success, the actual bits on failure; expectAny swaps unconditionally and returns the old bits. */
    private int jvmdgSubWordCas(Object base, long offset, int type, int expectedBits, int newBits, boolean expectAny) {
        synchronized (jvmdgLockFor(base, offset)) {
            int cur = jvmdgReadSubWord(base, offset, type);
            if (!expectAny && cur != expectedBits) {
                return cur;
            }
            jvmdgWriteSubWord(base, offset, type, newBits);
            return expectAny ? cur : expectedBits;
        }
    }

    /** Atomic read-modify-write; op: 0 add, 1 or, 2 and, 3 xor. Returns the old bits. */
    private int jvmdgSubWordGetAndOp(Object base, long offset, int type, int operand, int op) {
        int valueMask = type <= 1 ? 0xFF : 0xFFFF;
        synchronized (jvmdgLockFor(base, offset)) {
            int old = jvmdgReadSubWord(base, offset, type);
            int computed;
            switch (op) {
                case 0: computed = old + operand; break;
                case 1: computed = old | operand; break;
                case 2: computed = old & operand; break;
                default: computed = old ^ operand; break;
            }
            jvmdgWriteSubWord(base, offset, type, computed & valueMask);
            return old;
        }
    }
    // ==== end jvmdg patched helpers ====
